  ...
  jobs: [
    {
      ...
      endDate: 'Present',
      achievements: [
        'Implementé diseños de Figma en componentes de interfaz de usuario responsivos y con precisión de píxel',
        'Contribuí con componentes reutilizables a la biblioteca interna de componentes',
    ...
    },
    {
      ...
      achievements: [
        'Impulsé la eficiencia y la satisfacción del usuario a través de la creación y mejora de módulos en aplicaciones web.',
        'Integré nuevas funciones en aplicaciones web utilizando Vue.js en el Front-end y Laravel en el backend.',
