  ...
  jobs: [
    {
      ...
      startDate: "July 2024",
      endDate: "Present",
      achievements: ["Pixel perfect implementation from Figma designs.", "Keep projects updates, without packages vulnerabilities."],
    ...
    },
    {
      ...
      stack: ["React.js", "Next.js", "Kotlin", "JavaScript", "TypeScript", "Redux", "CSS", "MySQL", "Redis", "Git", "Docker", "Webpack", "Kubernetes", "i18n"],
    },
    {
      ...
      stack: ["Vue.js", "Laravel", "Vuex", "WordPress", "JavaScript", "TypeScript", "PHP", "Bootstrap", "Redis", "Git", "Docker", "Webpack"],
    },
  ],
};
